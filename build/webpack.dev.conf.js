...
var express = require('express')// nodejs开发框架express，用来简化操作
var axios = require('axios')//导入axios
var app = express() // 创建node.js的express开发框架的实例
...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    ...
    before(app){//设置代理
      app.get('/api/vkey', function (req, res) {//抓取音乐的vkey
      ...
      app.get('/api/search', function (req, res) {//抓取搜索结果
